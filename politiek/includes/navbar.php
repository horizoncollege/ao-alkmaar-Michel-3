                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item text-danger" href="sub_pag/contact.php">Contact</a></li>
                            <li><a class="dropdown-item text-danger" href="sub_pag/taakverdeling.php">Taakverdeling</a></li>
                        </ul>
                    </li>
                    <!-- Over ons knop -->
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item text-danger" href="sub_pag/wonen.php">Wonen</a></li>
                            <li><a class="dropdown-item text-danger" href="sub_pag/migratie.php">Migratie</a></li>
                            <li><a class="dropdown-item text-danger" href="sub_pag/onderwijs.php">Onderwijs</a></li>
                            <li><a class="dropdown-item text-danger" href="sub_pag/klimaat.php">Klimaat</a></li>
                        </ul>
                    </li>
                    <!-- Mensen knop -->
                    <li class="nav-item">
                    ...
                    <!-- Donate button -->
                    <li class="nav-item">
                        <a class="nav-link text-success" href="https://www.gofundme.com/nl-nl">Doneer</a>
                    </li>
                </ul>
            </div>
        </div>
